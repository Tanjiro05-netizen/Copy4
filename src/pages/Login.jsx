    ...
    return (
        <div className="login-page-container">
            <div className="login-page-background">
                <div className="login-page-content-wrapper text-white p-4">
                <div className="absolute top-6 right-6 z-20">
                    <button 
                        onClick={() => setShowLoginModal(true)} 
                        className="px-4 py-1 text-sm md:px-6 md:py-2 md:text-base bg-red-600 rounded-full font-medium hover:bg-red-700 transition shadow-lg"
                    >
                        Login
                    </button>
                </div>
                ...
                <div className="relative z-10 pt-16 pb-16 px-8 w-full">
                        ...
                        <div className="mb-8 text-center">
                            <h1 className="text-3xl md:text-6xl font-bold text-red-500 mb-6">Marxist Theory: Marxist.info</h1>
                            <p className="text-lg md:text-2xl text-gray-300 mb-2 [text-shadow:0_1px_3px_rgb(0_0_0_/_0.8)]">
