...
/* ── Profile tab ── */
export const banner = style({ position: 'relative', height: '192px', background: vars.color.surfaceSoft, borderRadius: `${vars.radius.xl} ${vars.radius.xl} 0 0`, display: 'flex', alignItems: 'center', justifyContent: 'center', border: `2px dashed ${vars.color.border}` });
...
export const avatarWrap = style({ position: 'absolute', top: '-64px', left: vars.space.xl, width: '128px', height: '128px', background: vars.color.surfaceSoft, borderRadius: '50%', border: `4px solid ${vars.color.background}`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: vars.color.textFaint });
...
export const saveRow = style({ display: 'flex', justifyContent: 'flex-end' });
