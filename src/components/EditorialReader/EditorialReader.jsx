...
/* Prose typography for extracted epub sections — one stylesheet, applied to the column.
   The first paragraph of the whole book carries the crimson drop cap. */
const editorialProseCss = `
