...
import { useParams, Link, useNavigate } from '@/src/lib/router-shim';
                            ...
                            {activeTab === 'posts' && (
                                <div className="space-y-4">
                                    {forumPosts.length > 0 ? forumPosts.map(post => (
                                        <Link to="/forum" key={post.id} className="block bg-gray-800/50 rounded-lg p-4 hover:bg-gray-800/80 transition-colors">
                            ...
                            {activeTab === 'replies' && (
                                <div className="space-y-4">
                                    {forumReplies.length > 0 ? forumReplies.map(reply => (
                                        <Link to="/forum" key={reply.id} className="block bg-gray-800/50 rounded-lg p-4 hover:bg-gray-800/80 transition-colors">
                            ...
                            {activeTab === 'reposts' && (
                                <div className="space-y-4">
                                    {forumReposts.length > 0 ? forumReposts.map(repost => (
                                        <Link to="/forum" key={repost.id} className="block bg-gray-800/50 rounded-lg p-4 hover:bg-gray-800/80 transition-colors">
