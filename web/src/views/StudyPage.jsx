    ...
    <div className={`${themeRoot} ${styles.page}`}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroBackdrop}>
          <img src={marxBackground} alt="Study Center archive" className={styles.heroImage} />
            ...
            <aside className={styles.heroAside}>
              <div className={styles.featurePanel}>
                ...
                <div className={styles.featureActionRow}>
                  ...
                  <Link to="/digital-library" className={actionButton({ tone: "subtle", size: "sm" })}>
                    Library
                  </Link>
                </div>
                ...
                <div className={styles.lecturesGrid}>
                  {lectureResources.slice(0, 3).map((item) => {
                    ...
                    return isExternal ? (
                      ...
                      <Link key={item.id} to={lectureHref} className={styles.lectureCard}>
                        {lectureCard}
                      </Link>
                    );
                  })}
