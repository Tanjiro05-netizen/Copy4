      ...
      <div className="min-h-screen bg-[#12131A]">
        ...
        <main className="pt-24 px-4">
          <div className="mx-auto max-w-3xl border border-gray-800 bg-black/35 p-8 text-center">
            ...
            <Link to={`/science-tech/courses/${courseSlug}`} className="mt-6 inline-flex items-center gap-2 text-red-400 hover:text-red-300">
      ...
      <main className="pt-20 pb-12">
        <div className="border-b border-gray-800 bg-black/30">
          <div className="container mx-auto max-w-5xl px-4 py-5">
            <Link to={`/science-tech/courses/${courseSlug}`} className="inline-flex items-center gap-2 text-gray-500 hover:text-white text-sm mb-3">
              <ArrowLeft className="w-4 h-4" />
              {data.course.title}
            </Link>
          ...
          {phase === 'results' && results && (
            <section className="space-y-5">
              ...
              <div className="flex flex-wrap justify-between gap-3">
                ...
                <button
                  type="button"
                  onClick={() => navigate(`/science-tech/courses/${courseSlug}`)}
