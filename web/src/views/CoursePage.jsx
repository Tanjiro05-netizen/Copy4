    ...
    return (
      <div className="min-h-screen bg-[#12131A]">
        ...
        <div className="pt-24 px-4 text-center">
          ...
          <Link to="/science-tech" className="text-red-400 hover:text-red-300 mt-4 inline-block">Back to Science & Technology</Link>
        </div>
      </div>
    );
  }
      ...
      <main className="pt-20 pb-12">
        <section className="border-b border-gray-800 bg-black/35">
          <div className="container mx-auto max-w-7xl px-4 py-7">
            <Link to="/science-tech" className="inline-flex items-center gap-2 text-gray-500 hover:text-white text-sm mb-5">
              ...
              <aside className="border border-gray-800 bg-black/30 p-4 h-fit">
                ...
                <div className="mt-4">
                  {enrolled && firstLesson ? (
                    <Link to={`/science-tech/courses/${course.slug}/${firstLesson.module.slug}/${firstLesson.lesson.slug}`} className="w-full inline-flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-3">
