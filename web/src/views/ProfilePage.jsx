...
import { Link, useSearchParams } from '@/src/lib/router-shim';
                ...
                <>
                    ...
                    <div className="bg-gray-800/50 rounded-lg border border-gray-700">
                        <div className="flex items-center justify-between p-4 border-b border-gray-700">
                            ...
                            <Link to="/science-tech" className="text-sm text-red-400 hover:text-red-300">Browse Courses →</Link>
                        </div>
                        <div className="divide-y divide-gray-700">
                            {enrollments.length > 0 ? enrollments.map(e => {
                                ...
                                return (
                                    <Link key={e.id} to={`/science-tech/courses/${course?.slug}`} className="flex items-center gap-4 p-4 hover:bg-gray-700/30 transition-colors">
                                ...
                                <div className="p-8 text-center text-gray-500">
                                    ...
                                    <Link to="/science-tech" className="text-red-400 hover:text-red-300 text-sm mt-2 inline-block">Browse courses →</Link>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <>
                    ...
                    <div className="bg-gray-800/50 rounded-lg border border-gray-700">
                        <div className="flex items-center justify-between p-4 border-b border-gray-700">
                            ...
                            <Link to="/knowledge" className="text-sm text-red-400 hover:text-red-300">View All →</Link>
                        </div>
                        <div className="divide-y divide-gray-700">
                            {userQuestions.length > 0 ? userQuestions.map(q => (
                                <Link key={q.id} to={`/knowledge/question/${q.id}`} className="flex items-center justify-between p-4 hover:bg-gray-700/30 transition-colors">
                                    <div className="flex-1 min-w-0">
                                ...
                                <div className="p-8 text-center text-gray-500">
                                    ...
                                    <Link to="/knowledge/ask" className="text-red-400 hover:text-red-300 text-sm mt-2 inline-block">Ask your first question →</Link>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800/50 rounded-lg border border-gray-700">
                        ...
                        <div className="divide-y divide-gray-700">
                            {userAnswers.length > 0 ? userAnswers.map(a => (
                                <Link key={a.id} to={`/knowledge/question/${a.question?.id}`} className="flex items-center justify-between p-4 hover:bg-gray-700/30 transition-colors">
                                    <div className="flex-1 min-w-0">
                                ...
                                <div className="p-8 text-center text-gray-500">
                                    <p>No answers yet.</p>
                                    <Link to="/knowledge" className="text-red-400 hover:text-red-300 text-sm mt-2 inline-block">Browse questions to answer →</Link>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="divide-y divide-gray-700">
                            {userFavorites.length > 0 ? userFavorites.map(q => (
                                ...
                                <div className="p-8 text-center text-gray-500">
                                    ...
                                    <Link to="/knowledge" className="text-red-400 hover:text-red-300 text-sm mt-2 inline-block">Browse questions to save →</Link>
                                </div>
                            )}
                        </div>
                    </div>
