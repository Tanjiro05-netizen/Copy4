      ...
      <div className={s.inner}>
          {isLoading ? (
            ...
            <div className={s.errorWrap}>
              ...
              <Link to={fallbackHref} className={s.errorLink}>{fallbackLabel}</Link>
            </div>
          ) : certificate && (
            <div className={s.successWrap}>
              ...
              <div className={s.card}>
                ...
                <div className={s.cardFooter}>
                  {canViewCourses ? (
                    <Link to={courseHref} className={s.primaryBtn}>View Course</Link>
                  ) : (
                    <>
                      <Link to="/login" className={s.primaryBtn}>Register to access courses</Link>
                      <Link to="/digital-library" className={s.secondaryBtn}>Browse public library</Link>
                    </>
                  )}
                </div>
              </div>
